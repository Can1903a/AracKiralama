...
if (isset($_POST['delete'])) {
    ...
    header("Location: /AracKiralama/AdminSayfalari/RezervasyonYonetimi.php");
    exit;
}
...
if (isset($_POST['update'])) {
    ...
    $update_query = "
        UPDATE Rezervasyon 
        SET alis_sube_id = $alis_sube_id, varis_sube_id = $varis_sube_id, arac_id = $arac_id 
...
<head>
    ...
    <link rel="stylesheet" href="/AracKiralama/AdminSayfalari/css/rezervasyondetay.css">
</head>
<body>
    <div class="sidebar">
        <h2>Admin Paneli</h2>
    ...
    <div class="content">
        ...
        <form method="POST">
            <div>
                <label for="alis_sube">Alış Şube:</label>
                <select name="alis_sube" id="alis_sube">
                    <?php while ($sube = mysqli_fetch_assoc($sube_result)): ?>
                        <option value="<?php echo $sube['Sube_id']; ?>" <?php if ($sube['Sube_id'] == $rezervasyon['alis_sube_id']) echo 'selected'; ?>>
